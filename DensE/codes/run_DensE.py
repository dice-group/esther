...
def save_model(model, optimizer, save_variable_list, args):
    ...
    np.savetxt(os.path.join(args.save_path, 'entity_x.csv'), entity_x_embedding, delimiter=",")
    np.savetxt(os.path.join(args.save_path, 'entity_y.csv'), entity_y_embedding, delimiter=",")
    np.savetxt(os.path.join(args.save_path, 'entity_z.csv'), entity_z_embedding, delimiter=",")
